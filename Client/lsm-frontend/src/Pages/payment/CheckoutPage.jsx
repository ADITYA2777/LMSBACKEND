...
import {
  ...
  verifyUserPayment,
} from "../../Redux/Slices/RazorpaySlices";
    ...
    <HomeLayout>
      ...
      >
        ...
        <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
          <h1 className="bg-gradient-to-br from-yellow-500 to-yellow-800 absolute top-0 w-full text-center py-4 text-2xl font-bold rounded-tl-lg rounded-tr-lg">
            Subscription Bundle
          </h1>
